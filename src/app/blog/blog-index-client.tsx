                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {post.tags.slice(0, 3).map(tag => (
                        <Badge 
                          key={tag} 
                          variant="secondary" 
                          className="bg-amber-500/10 text-accent border-amber-500/20 text-xs"
                        >
                          {tag}
                        </Badge>
                      ))}
              ...
              >
                ...
                >
                  <div className="flex-1">
                    <h3 className="font-semibold text-neutral-900 dark:text-white group-hover:text-accent transition-colors mb-1">
                      {post.title}
                    </h3>
