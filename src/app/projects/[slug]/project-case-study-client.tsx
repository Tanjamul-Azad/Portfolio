        ...
        <section className="bg-neutral-50 dark:bg-black py-6">
          <div className="container px-6 mx-auto">
            <motion.div
              ...
              className="relative max-w-5xl mx-auto aspect-video rounded-2xl overflow-hidden shadow-2xl ring-1 ring-neutral-200 dark:ring-neutral-800 bg-linear-to-br from-neutral-200 to-neutral-100 dark:from-neutral-900 dark:to-neutral-800"
            >
              <AnimatePresence>
                {!imageLoaded && (
                  <motion.div
              ...
              {project.challenges.map((item, index) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <span className="shrink-0 w-8 h-8 rounded-full bg-amber-500/20 text-amber-500 flex items-center justify-center text-sm font-bold">
                      {index + 1}
                    </span>
                    <div>
                      ...
                      <p className="text-neutral-600 dark:text-neutral-400 text-sm leading-relaxed">
                        <span className="text-amber-500 font-medium">What I learned:</span> {item.learned}
                      </p>
                    </div>
                  </div>
                </motion.div>
