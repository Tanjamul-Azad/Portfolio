  ...
  return (
    <div className="sticky bottom-0 z-10 mt-8 flex flex-col gap-3 border-t border-neutral-200 bg-neutral-50/90 py-3 backdrop-blur sm:flex-row sm:items-center sm:justify-between dark:border-neutral-800 dark:bg-neutral-950/90">
      <p className="text-xs text-neutral-500">
        {/* The editor runs in two places and saves to two different destinations,
            so the hint has to say which one this is. */}
        {deployed
          ? "Saving commits to GitHub and triggers a rebuild — live in about a minute."
          : "Saving writes to your local project files. Push to publish."}
      </p>
